 ...
 *    Column 4 is the expected within-cross segregation variance
 */
// [[Rcpp::export]]
arma::mat calcCrossMean(arma::mat& geno,
  ...
  // Additional maps for second moments
  ...
  // Calculate cross means and segregation variances for partial diallel
